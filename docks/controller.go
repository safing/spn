...
func initCraneController(
	...
	// Create Flow Queue.
	dfq := terminal.NewDuplexFlowQueue(t, initMsg.QueueSize, crane.submitImportantTerminalMsg)
	...
	// Start workers.
	module.StartWorker("crane controller terminal", cct.Handler)
